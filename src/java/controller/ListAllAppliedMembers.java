 ...
 * @author Alex
 */
public class ListAllAppliedMembers extends HttpServlet {
...
//            }
            ...
            if (session != null && session.getAttribute("admin-authenticated") != null) {
                ...
                RequestDispatcher view = request.getRequestDispatcher("admin/list-applied-members.jsp");
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(ListAllAppliedMembers.class.getName()).log(Level.SEVERE, null, ex);
